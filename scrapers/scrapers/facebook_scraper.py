# scrapers/scrapers/facebook_scraper.py
...
def parse_html(html: str) -> list[dict]:
    ...
    # TODO: replace selectors with real Facebook Marketplace structure
...
def build_url(query: str | None) -> str:
    base = "https://www.facebook.com/marketplace/search/?query="
